...
IFontDisp = Font
__all__ = [ 'OLE_COLOR', 'OLE_ENABLEDEFAULTBOOL', 'OLE_YPOS_PIXELS',
           'FONTUNDERSCORE', 'LoadPictureConstants', 'FontEvents',
           'OLE_XPOS_CONTAINER', 'OLE_YPOS_HIMETRIC',
           'OLE_YSIZE_CONTAINER', 'Font', 'Checked', 'StdFont',
           'OLE_XPOS_PIXELS', 'Picture', 'FONTNAME', 'Gray',
           'OLE_CANCELBOOL', 'Color', 'FONTITALIC', 'FONTBOLD',
           'Unchecked', 'IFontDisp', 'FONTSTRIKETHROUGH',
           'OLE_OPTEXCLUSIVE', 'OLE_HANDLE', 'OLE_XSIZE_CONTAINER',
           'OLE_YSIZE_PIXELS', 'IPicture', 'OLE_XPOS_HIMETRIC',
           'OLE_XSIZE_HIMETRIC', 'OLE_XSIZE_PIXELS', 'IPictureDisp',
           'OLE_TRISTATE', 'StdPicture', 'Default',
           'OLE_YPOS_CONTAINER', 'FONTSIZE', 'IFont', 'Monochrome',
           'VgaColor', 'OLE_YSIZE_HIMETRIC', 'IFontEventsDisp']
